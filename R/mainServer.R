...
mainServer <- function(input, output, session) {
  ...
  source(system.file("shiny", "myApp/modules/13-server-clusterProfiler.R", package = "QRseq"), local = T)
  source(system.file("shiny", "myApp/modules/14-server-gProfiler.R", package = "QRseq"), local = T)
  source(system.file("shiny", "myApp/modules/15-server-ppi-network.R", package = "QRseq"), local = T)
  source(system.file("shiny", "myApp/modules/16-server-genie3-network.R", package = "QRseq"), local = T)
}
