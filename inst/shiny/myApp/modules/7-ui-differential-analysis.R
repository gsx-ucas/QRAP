fluidPage(
  ...
  box(
    title = "Detecting Differentially Expressed Genes:", id = "dea_tab", width = 12, collapsible = TRUE,
    fluidRow(
  ...
  tabsetPanel(
    tabPanel(
      ...
      fluidPage(
        ...
        column(
          4, style = "padding: 0px; margin: 0px;",
          box(
            title = "Plot parameters:", width = 12, status = NULL,
  ...
  column(
    12, hr(),
    fluidRow(column(2), column(3, actionLink("pDEA", "<< Previous", style = "font-size: 20px")),
             column(4, p("You are in differential analysis page ...", style = "color: grey; font-size: 20px")),
             column(3, actionLink("nDEA", "Next >>", style = "font-size: 20px")))
  )
)
