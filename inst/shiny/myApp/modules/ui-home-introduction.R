fluidPage(
  ...
  column(
    9,
    includeMarkdown(system.file("doc", "installation.md", package = "QRseq"))
    ...
    # h3("Getting Start", id = "get-start", style = "width:100%; text-align:left;font-family:'Times New Roman', Times, serif;"),
    # p("We propose a web application (QRseq) for exploring and analyzing RNA sequencing data."),

    # fluidRow(
    #   column(6, tags$img(src = "images/workflow.tiff",width = "70%")),
    #   column(6, tags$img(src = "images/workflow.tiff",width = "70%"))
    # ),
