fluidPage(
  ...
  box(
    title = "Runing GSEA or ORA:", id = "clp_gsea_tab", width = 12, collapsible = TRUE,
    fluidRow(
  ...
  column(
    12,
    hr(),
    fluidRow(column(2), column(3, actionLink("pGSEA", "<< Previous", style = "font-size: 20px")),
             column(4, p("You are in clusterProfiler page ...", style = "color: grey; font-size: 20px")),
             column(3, actionLink("nGSEA", "Next >>", style = "font-size: 20px")))
  )
)
